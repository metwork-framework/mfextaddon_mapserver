...
## How to install mfextaddon_mapserver metwork module
...
yum install metwork-mfextaddon_mapserver
```

```console tab="Mageia"
urpmi metwork-mfextaddon_mapserver
```

```console tab="SUSE"
zypper install metwork-mfextaddon_mapserver
```




### Full installation (all mfextaddon_mapserver layers)


If you prefer a full installation (as `root` user):

```console tab="CentOS/Fedora"
yum install metwork-mfextaddon_mapserver-full
```

```console tab="Mageia"
urpmi metwork-mfextaddon_mapserver-full
```

```console tab="SUSE"
zypper install metwork-mfextaddon_mapserver-full
```
...
You can also add extra (optional) `mfextaddon_mapserver` layers.
