...
`MFEXTADDON_MAPSERVER_HOME` | alias of `MFMODULE_HOME` if the current loaded metwork module is `mfextaddon_mapserver` | `/opt/metwork-mfserv-0.8`
`MFEXTADDON_MAPSERVER_VERSION` | alias of `MFMODULE_VERSION` if the current loaded metwork module is `mfextaddon_mapserver` | `0.9.4`, `integration.ci1036.1949d86`
