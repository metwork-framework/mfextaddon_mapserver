...
#if test -f "${BUILDCACHE}/build_hash_mfext}_${BRANCH}_`cat .build_hash`"; then
...
#rm -f ${BUILDCACHE}/build_hash_mfext}_${BRANCH}_*
#touch ${BUILDCACHE}/build_hash_mfext}_${BRANCH}_`cat .build_hash`
#ls -l ${BUILDCACHE}
