...
html_context = {
    ...
    'github_repo': 'mfextaddon_mapserver',
...
project = u'mfextaddon_mapserver'
...
htmlhelp_basename = 'mfextaddon_mapserverdoc'
...
latex_documents = [
    (master_doc, 'mfextaddon_mapserver.tex',
     u'mfextaddon_mapserver Documentation',
     u'MetWork', 'manual'),
]
...
man_pages = [
    (master_doc, 'mfextaddon_mapserver', u'mfextaddon_mapserver Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mfextaddon_mapserver', u'mfextaddon_mapserver Documentation',
     author, 'mfextaddon_mapserver', 'One line description of project.',
     'Miscellaneous'),
]
